...
const GameHub = ({ user, onSelectGame, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F0FDF4] p-6 sm:p-12 lg:p-16">
      {/* Header */}
      <header className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10 mb-20">
      ...
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto mb-24 relative rounded-[3.5rem] overflow-hidden bg-emerald-900 p-12 text-white shadow-[0_40px_100px_rgba(0,150,96,0.2)]">
