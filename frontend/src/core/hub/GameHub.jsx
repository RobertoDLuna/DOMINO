  ...
  return (
    <aside className="w-20 lg:w-72 bg-white h-screen fixed left-0 top-0 border-r-2 border-emerald-50 flex flex-col items-center lg:items-stretch p-4 lg:p-6 z-30 transition-all duration-300">
      ...
      <div className="flex flex-col items-center lg:items-start gap-4 mb-12">
        <div className="flex items-center gap-2">
          <img src={logoCampina} alt="Seduc" className="h-8 lg:h-10 w-auto object-contain" />
          <div className="hidden lg:block w-px h-6 bg-emerald-100"></div>
          <img src={logoPrefeitura} alt="Prefeitura" className="hidden lg:block h-10 w-auto object-contain" />
        </div>
      ...
      <nav className="flex-1 w-full space-y-2">
        <button className="w-full flex items-center gap-4 p-4 rounded-2xl bg-emerald-50 text-[#009660] font-black text-xs uppercase tracking-widest transition-all">
        ...
        {user?.role === 'ADMIN' && (
          ...
          >
            ...
            <span className="hidden lg:block text-left">Painel Admin</span>
          </button>
        )}
      </nav>
      ...
      <div className="mt-auto space-y-4">
        <div className="hidden lg:flex items-center gap-4 bg-emerald-50 p-4 rounded-3xl border border-emerald-100">
          <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white font-black text-lg shrink-0">
        ...
        <button 
          onClick={onLogout}
          className="w-full flex items-center justify-center lg:justify-start gap-4 p-4 rounded-2xl text-red-500 hover:bg-red-50 font-black text-xs uppercase tracking-widest transition-all group"
        >
    ...
    <div className="min-h-screen bg-[#F0FDF4] flex">
      ...
      <main className="flex-1 pl-20 lg:pl-72 transition-all duration-300">
        <div className="p-6 sm:p-12 lg:p-16 max-w-7xl mx-auto">
          ...
          {/* Hero Section */}
          <section className="mb-24 relative rounded-[3.5rem] overflow-hidden bg-emerald-900 p-8 lg:p-12 text-white shadow-[0_40px_100px_rgba(0,150,96,0.2)]">
            <div className="relative z-10 max-w-2xl">
              ...
              <h2 className="text-4xl lg:text-5xl font-black mb-6 leading-none italic uppercase tracking-tighter drop-shadow-md">
                Torneio de Dominó <br /> <span className="text-[#FFCE00]">Interescolar</span>
              </h2>
              <p className="text-emerald-100/80 text-base lg:text-lg font-medium mb-8 leading-tight max-w-lg border-l-4 border-[#FFCE00] pl-6">
